...
if __name__ == '__main__':
    ...
    features = ['generator_speed', 'power', 'environment_tmp', 'r_windspeed_to_power',
       ...
       'environment_tmp_lag160', 'environment_tmp_lag240',
    ...
    features_p1 = ['wind_speed', 'generator_speed', 'power', 'environment_tmp', 'cp', 'ct',
       ...
       'moto_tmp_mean', 'wind_speed_lag40', 'wind_speed_lag80',
       'wind_speed_lag160', 'wind_speed_lag240', 'wind_speed_lag400',
       'wind_speed_lag560', 'environment_tmp_lag240', 'environment_tmp_lag400',
       'environment_tmp_lag560']

    features_p2 = ['wind_speed', 'generator_speed', 'power', 'acc_x', 'environment_tmp',
       'pitch1_ng5_tmp', 'pitch2_ng5_tmp', 'tmp_diff', 'r_windspeed_to_power',
       'r_windspeed_to_generator_speed', 'r_square', 'moto_tmp_mean',
       'wind_speed_lag560', 'environment_tmp_lag80', 'environment_tmp_lag160',
       'environment_tmp_lag240', 'environment_tmp_lag400',
       'environment_tmp_lag560']
    ...
    """
    knn: KNN = KNN(clf, train, test, features, target, 5, 'KNN_Rule_TimeSeriesInfo')
    ...
    knn1: KNN = KNN(clf, train_part1, test_part1, features_p1, target, 5, 'KNN_Rule_Division_TimeSeriesInfo_part1')
    train_y1, train_pred_y1, test_y1, test_pred_y1 = knn1.train_model()
    knn2: KNN = KNN(clf, train_part2, test_part2, features_p2, target, 5, 'KNN_Rule_Division_TimeSeriesInfo_part2')
